...
angular.module('myAppServices', [])
    ...
    .service('gameCommands', //commands
        function($http) {
            ...
            this.handleMove = function(pawnField, destinationField, mustKill, callback) {
            ...
            this.canMoveQueen = function(pawnField, callback) {
                return $http.get(this.baseURL + 'canMoveQueen', {
                    params: {
                        pawnFieldX: pawnField.x,
                        pawnFieldY: pawnField.y,
                    }
